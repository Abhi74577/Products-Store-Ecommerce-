        ...
        <div className='flex justify-between items-center py-2 font-medium'>
            ...
            <div className='flex items-center gap-5'>
                ...
                <div className='group relative'>
                    <Link to='login'><LuUsersRound className='text-xl sm:text-[22px] cursor-pointer' /></Link>
                ...
                <RiMenuFoldLine className='text-xl sm:text-[25px] min-w-5 block sm:hidden cursor-pointer' onClick={() => { setIsMenu(true) }} />
            </div>
